...
const string strMessageMagic = "Diode Signed Message:\n";
...
bool CBlock::AcceptBlock()
{
    ...
    if (IsProofOfStake() && nHeight < POS_BLOCK)
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Diode", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "techcrunch.com, U.S. Marshals Service Is Putting 50,000 Bitcoins Up For Sale, November 17 2014";
        CTransaction txNew;
        txNew.nTime = 1416284064;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1416284064;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1908039;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x10a0f2f620d32b4cee902f8d180cef1186a8fb6d73ff9bd4324be241bfe41192"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa5, 0xb1, 0xea, 0xad };
